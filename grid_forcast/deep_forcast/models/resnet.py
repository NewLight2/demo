...
def st_resnet(c_input, p_input, t_input, c_conf, p_conf, t_conf, nb_filter, phase_train, nb_res_unit=1):
    outputs = []
...
#                nb_income = batch_norm(income, nb_flow * len_seq, phase_train)
...
#                    nb_conv1 = batch_norm(conv1, nb_filter, phase_train)
...
#        act_merge = batch_norm(merge_outputs, nb_flow, phase_train)
